...
urlpatterns = [
    ...
    path('delete_from_shop_cart/', views.delete_shop_cart, name='delete_from_shop_cart'),
    ...
    path('applay_coupen/<int:order_id>/', views.ApplayCoupon.as_view(), name='applay_coupen')
]
